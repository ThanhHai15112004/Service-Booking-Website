...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 30, 2025 lúc 09:52 AM
...
('adult_age_threshold', 'Ngưỡng tuổi người lớn', 'Adult Age Threshold', 'Độ tuổi tính là người lớn', 'INTEGER', 'ROOM', NULL, 15, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('airport_shuttle', 'Đưa đón sân bay', 'Airport Shuttle', 'Khách sạn có dịch vụ đưa đón sân bay', 'BOOLEAN', 'HOTEL', NULL, 9, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('breakfast_included', 'Bao gồm bữa sáng', 'Breakfast Included', 'Giá phòng đã bao gồm bữa sáng', 'BOOLEAN', 'HOTEL', NULL, 12, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('checkin_age_limit', 'Độ tuổi tối thiểu nhận phòng', 'Check-in Age Limit', 'Độ tuổi tối thiểu để check-in', 'INTEGER', 'ROOM', NULL, 13, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('children_allowed', 'Cho phép trẻ em', 'Children Allowed', 'Phòng chấp nhận khách mang theo trẻ em', 'BOOLEAN', 'ROOM', NULL, 4, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('extra_bed_allowed', 'Cho phép giường phụ', 'Extra Bed Allowed', 'Phòng có thể thêm giường phụ', 'BOOLEAN', 'ROOM', NULL, 6, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('extra_bed_fee', 'Phí giường phụ', 'Extra Bed Fee', 'Chi phí thêm giường phụ (VND)', 'DECIMAL', 'ROOM', NULL, 7, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('free_cancellation', 'Miễn phí hủy', 'Free Cancellation', 'Có thể hủy đặt phòng mà không mất phí', 'BOOLEAN', 'BOTH', NULL, 1, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('free_child_age_limit', 'Độ tuổi trẻ em miễn phí', 'Free Child Age Limit', 'Trẻ em dưới độ tuổi này được ở miễn phí', 'INTEGER', 'ROOM', NULL, 14, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('no_credit_card', 'Không cần thẻ tín dụng', 'No Credit Card Required', 'Đặt phòng không yêu cầu thẻ tín dụng', 'BOOLEAN', 'BOTH', NULL, 3, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('parking_available', 'Có bãi đỗ xe', 'Parking Available', 'Khách sạn có bãi đỗ xe', 'BOOLEAN', 'HOTEL', NULL, 10, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('parking_fee', 'Phí đỗ xe', 'Parking Fee', 'Chi phí đỗ xe mỗi ngày (VND)', 'DECIMAL', 'HOTEL', NULL, 11, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('pay_later', 'Thanh toán sau', 'Pay Later', 'Không cần thanh toán ngay, trả tiền khi nhận phòng', 'BOOLEAN', 'BOTH', NULL, 2, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('pets_allowed', 'Cho phép thú cưng', 'Pets Allowed', 'Phòng cho phép mang theo thú cưng', 'BOOLEAN', 'ROOM', NULL, 5, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41'),
('smoking_allowed', 'Cho phép hút thuốc', 'Smoking Allowed', 'Phòng cho phép hút thuốc', 'BOOLEAN', 'ROOM', NULL, 8, 1, '2025-10-30 15:11:41', '2025-10-30 15:11:41');
...
('S001', 'R001', '2025-10-20', 800000.00, 0.00, 1, 1, 0, '2025-10-20 15:09:17'),
...
('S004', 'R003', '2025-10-20', 1800000.00, 0.00, 1, 1, 0, '2025-10-20 15:09:17'),
...
('S007', 'R003', '2025-10-21', 1850000.00, 0.00, 1, 1, 0, '2025-10-20 15:09:17'),
...
('S010', 'R001', '2025-10-25', 800000.00, 0.00, 1, 1, 0, '2025-10-22 10:09:16'),
...
('S013', 'R003', '2025-10-25', 1800000.00, 0.00, 1, 1, 0, '2025-10-22 10:09:16'),
...
('S071', 'R003', '2025-10-26', 1800000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S072', 'R003', '2025-10-27', 1800000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S073', 'R003', '2025-10-28', 1800000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S074', 'R003', '2025-10-29', 1800000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S075', 'R003', '2025-10-30', 1800000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S076', 'R003', '2025-10-31', 1800000.00, 5.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S077', 'R003', '2025-11-01', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S078', 'R003', '2025-11-02', 1820000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S079', 'R003', '2025-11-03', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S080', 'R003', '2025-11-04', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S081', 'R003', '2025-11-05', 1820000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S082', 'R003', '2025-11-06', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S083', 'R003', '2025-11-07', 1820000.00, 5.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S084', 'R003', '2025-11-08', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S085', 'R003', '2025-11-09', 1820000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S086', 'R003', '2025-11-10', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S087', 'R003', '2025-11-11', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S088', 'R003', '2025-11-12', 1820000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S089', 'R003', '2025-11-13', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S090', 'R003', '2025-11-14', 1820000.00, 5.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S091', 'R003', '2025-11-15', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S092', 'R003', '2025-11-16', 1820000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S093', 'R003', '2025-11-17', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S094', 'R003', '2025-11-18', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S095', 'R003', '2025-11-19', 1820000.00, 10.00, 1, 1, 0, '2025-10-24 11:34:15'),
('S096', 'R003', '2025-11-20', 1820000.00, 0.00, 1, 1, 0, '2025-10-24 11:34:15'),
...
--
-- Cấu trúc đóng vai cho view `v_hotel_policies`
-- (See below for the actual view)
--
CREATE TABLE `v_hotel_policies` (
`hotel_id` varchar(20)
,`policy_key` varchar(50)
,`name_vi` varchar(100)
,`name_en` varchar(100)
,`data_type` enum('BOOLEAN','INTEGER','DECIMAL','TEXT')
,`value` text
,`formatted_value` mediumtext
);

-- --------------------------------------------------------

--
-- Cấu trúc đóng vai cho view `v_room_policies`
-- (See below for the actual view)
--
CREATE TABLE `v_room_policies` (
`room_id` varchar(20)
,`policy_key` varchar(50)
,`name_vi` varchar(100)
,`name_en` varchar(100)
...
--
-- Cấu trúc đóng vai cho view `v_room_type_availability`
-- (See below for the actual view)
--
CREATE TABLE `v_room_type_availability` (
`room_type_id` varchar(20)
,`hotel_id` varchar(20)
,`room_type_name` varchar(100)
,`total_physical_rooms` bigint(21)
,`date` date
,`total_available_on_date` decimal(32,0)
,`validation_status` varchar(34)
);

-- --------------------------------------------------------

--
-- Cấu trúc cho view `v_hotel_policies`
--
DROP TABLE IF EXISTS `v_hotel_policies`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_hotel_policies`  AS SELECT `hp`.`hotel_id` AS `hotel_id`, `hp`.`policy_key` AS `policy_key`, `pt`.`name_vi` AS `name_vi`, `pt`.`name_en` AS `name_en`, `pt`.`data_type` AS `data_type`, `hp`.`value` AS `value`, CASE WHEN `pt`.`data_type` = 'BOOLEAN' THEN if(`hp`.`value` = '1','Yes','No') WHEN `pt`.`data_type` = 'DECIMAL' THEN concat(format(cast(`hp`.`value` as decimal(12,2)),0),' VND') WHEN `pt`.`data_type` = 'INTEGER' THEN `hp`.`value` ELSE `hp`.`value` END AS `formatted_value` FROM (`hotel_policy` `hp` join `policy_type` `pt` on(`pt`.`policy_key` = `hp`.`policy_key`)) WHERE `pt`.`is_active` = 1 ;

-- --------------------------------------------------------

--
-- Cấu trúc cho view `v_room_policies`
--
DROP TABLE IF EXISTS `v_room_policies`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_room_policies`  AS SELECT `rp`.`room_id` AS `room_id`, `rp`.`policy_key` AS `policy_key`, `pt`.`name_vi` AS `name_vi`, `pt`.`name_en` AS `name_en`, `pt`.`data_type` AS `data_type`, `rp`.`value` AS `value`, CASE WHEN `pt`.`data_type` = 'BOOLEAN' THEN if(`rp`.`value` = '1','Yes','No') WHEN `pt`.`data_type` = 'DECIMAL' THEN concat(format(cast(`rp`.`value` as decimal(12,2)),0),' VND') WHEN `pt`.`data_type` = 'INTEGER' THEN concat(`rp`.`value`,' tuổi') ELSE `rp`.`value` END AS `formatted_value` FROM (`room_policy` `rp` join `policy_type` `pt` on(`pt`.`policy_key` = `rp`.`policy_key`)) WHERE `pt`.`is_active` = 1 ;

-- --------------------------------------------------------

--
-- Cấu trúc cho view `v_room_type_availability`
--
DROP TABLE IF EXISTS `v_room_type_availability`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_room_type_availability`  AS SELECT `rt`.`room_type_id` AS `room_type_id`, `rt`.`hotel_id` AS `hotel_id`, `rt`.`name` AS `room_type_name`, count(distinct `r`.`room_id`) AS `total_physical_rooms`, `rps`.`date` AS `date`, sum(`rps`.`available_rooms`) AS `total_available_on_date`, CASE WHEN sum(`rps`.`available_rooms`) > count(distinct `r`.`room_id`) THEN 'ERROR: Available > Physical Rooms!' ELSE 'OK' END AS `validation_status` FROM ((`room_type` `rt` join `room` `r` on(`r`.`room_type_id` = `rt`.`room_type_id` and `r`.`status` = 'ACTIVE')) join `room_price_schedule` `rps` on(`rps`.`room_id` = `r`.`room_id`)) GROUP BY `rt`.`room_type_id`, `rt`.`hotel_id`, `rt`.`name`, `rps`.`date` ;
