    ...
    try {
      ...
      setTimeout(() => {
        setPolicies([
          ...
          {
            id: 2,
            policy_key: "max_children",
            name: "Số trẻ em tối đa",
            value: "2",
            data_type: "INTEGER",
        ...
        setPolicyTypes([
          { policy_key: "free_cancellation", name: "Hủy miễn phí", data_type: "BOOLEAN" },
          { policy_key: "max_children", name: "Số trẻ em tối đa", data_type: "INTEGER" },
          { policy_key: "extra_bed_fee", name: "Phí giường phụ", data_type: "DECIMAL" },
        ]);
        setLoading(false);
      }, 500);
    } catch (error: any) {
