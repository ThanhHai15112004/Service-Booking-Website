...
import { Package, Calendar, CreditCard, RefreshCw, X, DollarSign, CheckCircle, Clock, AlertCircle, Star, Trash2, Eye, Filter } from "lucide-react";
import Loading from "../../../Loading";
import Toast from "../../../Toast";
import { adminService } from "../../../../services/adminService";

interface AccountPackagesTabProps {
  accountId: string;
}
...
const AccountPackagesTab = ({ accountId }: AccountPackagesTabProps) => {
              ...
              {subscriptions.length === 0 ? (
                ...
                subscriptions.map((sub) => (
                  <tr key={sub.subscription_id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 font-medium">{sub.package_name}</td>
...
export default AccountPackagesTab;
